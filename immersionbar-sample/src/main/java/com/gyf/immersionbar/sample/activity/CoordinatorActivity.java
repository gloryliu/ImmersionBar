...
public class CoordinatorActivity extends BaseActivity<ActivityCoordinatorBinding> {
    ...
    @Override
    protected ActivityCoordinatorBinding createViewBinding() {
    ...
    protected void initImmersionBar() {
        ...
        ImmersionBar.with(this).titleBar(mBinding.detailToolbar).init();
    }
    ...
    protected void initView() {
        ...
        mBinding.text.setText("关于Snackbar在4.4和emui3.1上高度显示不准确的问题是由于沉浸式使用了系统的" +
    ...
    protected void setListener() {
        mBinding.fab.setOnClickListener(view -> Snackbar.make(view, "我是Snackbar", Snackbar.LENGTH_LONG).show());
        //toolbar返回按钮监听
        mBinding.detailToolbar.setNavigationOnClickListener(v -> finish());
    }
}
