...
public class ActionBarActivity extends BaseActivity<ActivityActionBarBinding> {
    ...
    @Override
    protected ActivityActionBarBinding createViewBinding() {
    ...
    protected void initView() {
        ...
        mBinding.text.setText("上面图片被actionBar遮挡住了,我想使布局从actionBar下面开始绘制，怎么办？");
