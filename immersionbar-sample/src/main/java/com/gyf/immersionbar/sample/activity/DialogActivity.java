 ...
 * @date 2017/7/31
 */
public class DialogActivity extends BaseActivity<ActivityDialogBinding> implements DialogInterface.OnDismissListener {
    ...
    @Override
    protected ActivityDialogBinding createViewBinding() {
    ...
    protected void setListener() {
        mBinding.btnFullFragment.setOnClickListener(v -> {
        ...
        mBinding.btnTopFragment.setOnClickListener(v -> {
        ...
        mBinding.btnBottomFragment.setOnClickListener(v -> {
        ...
        mBinding.btnLeftFragment.setOnClickListener(v -> {
        ...
        mBinding.btnRightFragment.setOnClickListener(v -> {
        ...
        ClickHelper.setClickListeners(mBinding, this::onClick, R.id.btn_full, R.id.btn_top, R.id.btn_bottom, R.id.btn_left, R.id.btn_right);
    }
